    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-zinc-800/50 bg-zinc-950/80 backdrop-blur-sm p-6">
        ...
        <Button
          ...
          className="mb-4 bg-gradient-to-br from-violet-500 to-violet-600 text-white shadow-[0_0_15px_-5px_rgba(139,92,246,0.3)] border-t border-white/20"
        >
          ...
          <div className="flex gap-3 p-4 border rounded-xl bg-zinc-900/50">
            ...
            <div className="flex flex-col gap-2">
              <Button
                ...
                className="bg-gradient-to-br from-violet-500 to-violet-600 text-white shadow-[0_0_15px_-5px_rgba(139,92,246,0.3)] border-t border-white/20"
              >
